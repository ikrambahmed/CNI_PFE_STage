...
public interface  AvoirBudgetRepository extends JpaRepository<AvoirBudget, AvoirBudgetPK>
{
	...
	@Query("select a from AvoirBudget a , DeptGen d where d.code=:codeDept and a.avoiBudgetPK.code= d.code and a.avoiBudgetPK.date_budg=:x ")
	List<AvoirBudget> findBugetByDeptByYears(@Param("codeDept") String codeDept, @Param("x") Date date_budg);
